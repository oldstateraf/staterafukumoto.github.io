...
function hideSidebar(){
    ...
    document.getElementById("hamborger").style.display = "block"
    document.getElementById("shadow").style.display = "none"
    document.getElementById("rightwrapper").style.left = "0px"
}

function showSidebar(){
    document.getElementById("leftwrapper").style.display = "block"
    document.getElementById("hamborger").style.display = "none"
    document.getElementById("rightwrapper").style.left = "400px"
